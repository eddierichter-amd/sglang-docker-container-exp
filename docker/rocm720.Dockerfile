...
ARG BASE_IMAGE_942_ROCM720="rocm/pytorch:rocm7.2_ubuntu24.04_py3.12_pytorch_release_2.9.1"
ARG BASE_IMAGE_950="rocm/sgl-dev:rocm7-vllm-20250904"
ARG BASE_IMAGE_950_ROCM720="rocm/pytorch:rocm7.2_ubuntu24.04_py3.12_pytorch_release_2.9.1"
...
# -----------------------
# Hot patch: torch-ROCm metadata
# Torch pins an exact Triton build in the base ROCm image. Once Triton is
# rebuilt in this image, future pip operations can try to revert it unless we
# relax torch's installed dependency metadata in-place.
COPY patch_torch_triton_metadata.py /tmp/patch_torch_triton_metadata.py
RUN python /tmp/patch_torch_triton_metadata.py && rm -f /tmp/patch_torch_triton_metadata.py
...
ENV PYTHONPATH="/sgl-workspace/aiter:/sgl-workspace/mori/python:${PYTHONPATH}"
